...
units.push(serialNetwork(7, '08 - START: latch perintah jalan', [
  { name: 'StartButton' }, { name: 'StartPrev', negated: true }, { name: 'FirstScan', negated: true }, { name: 'ResetButton', negated: true }, { name: 'StopOK' }, { name: 'EStopOK' }, { name: 'OverloadOK' }, { name: 'JamSensor', negated: true }, { name: 'FaultLatch', negated: true },
], 'RunLatch', 'SCoil'));
